...
from django.contrib import admin
from django.urls import path, include
from authapp.views import RegisterView, UserDetailView, OrganisationListCreateView, OrganisationDetailView, AddUserToOrganisationView
from rest_framework.routers import DefaultRouter

router = DefaultRouter()
router.register(r'organisations', OrganisationListCreateView, basename='organisation')
